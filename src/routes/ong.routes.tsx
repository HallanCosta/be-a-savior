...
export function OngRoutes() {
  ...
  return (
    ...
    >
      ...
      <Screen name="CreateIncident" component={CreateIncident} />
      <Screen name="MyIncidents" component={MyIncidents} />
      <Screen name="MyDonatedIncidents" component={MyDonatedIncidents} />
      <Screen name="EditIncident" component={EditIncident} />
